...
AAS_VanillaDefaults = [
    ...
    ["AAS_LOG_Equip3_Container",         false                                ],
    ["AAS_LOG_Equip3_ForceRope",         true                               ],
    ...
    ["AAS_LOG_Equip6_Container",         false                                ],
    ["AAS_LOG_Equip6_ForceRope",         true                               ],
    ...
    ["AAS_LOG_Veh6_Container",           false                                ],
    ["AAS_LOG_Veh6_ForceRope",           true                               ],
